...
class CreatePartyMember extends React.Component {
  ...
  onSubmitCreateCreature(e) {
    e.preventDefault();
    this.props.addToPartyMembers(this.state);
  ...
  render() {
    return (
      <div className="create-party-member-form-wrapper">
        <form
          className="create-party-member-form"
        ...
        >
          ...
          <span className="party-member-description-form-wrapper">
            <input
              className="party-member-description-hit-point-input"
              name="maxHP"
              type="number"
              min="0"
              size="4"
            ...
            />
            <input
              className="party-member-description-armour-input"
              name="armorClass"
              type="number"
              min="0"
              size="4"
          ...
          <button className="create-party-member-button">
            <img
              width="25"
              height="25"
              src="https://s3.amazonaws.com/the-initiative-project/party-member-add.svg"
            />
          </button>
        </form>
      </div>
