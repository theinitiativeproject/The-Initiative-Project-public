		...
		return(
			<div className={ "party-member-item-wrapper " + (this.props.character.npc ? "character-npc" : "")}>
				...
				<span className="party-member-description-wrapper">
					...
					{ this.props.character.armorClass && <span className="party-member-description-armour"><img width="25" height="25" src="https://s3.amazonaws.com/the-initiative-project/dark-shield.svg"/>: {this.props.character.armorClass}</span>}
				</span>
			</div>
		);
  }
